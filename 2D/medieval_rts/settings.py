...
UPKEEP_TICK_S    = 1.8
DIPLOMACY_TICK_S = 1.25
SUPPRESSION_TICK_S = 1.0
NAVAL_PLANNING_TICK_S = 1.4
TREATY_MIN_DURATION_S = 14.0
WAR_EXHAUSTION_MAX = 8.0
TRIBUTE_INTERVAL_S = 7.0
MUTINY_STABILITY_THRESHOLD = 18.0
DESERTION_STABILITY_THRESHOLD = 34.0
CAPITAL_FOOD_MIN_DAYS = 3.5
CAPITAL_GOLD_MIN_DAYS = 3.0
PROFILER_ENABLED = True
PROFILER_HISTORY_FRAMES = 180
PROFILER_CAPTURE_SECONDS = 10.0
INSTALLER_THEME_NAME = "tiny_swords_tr"
